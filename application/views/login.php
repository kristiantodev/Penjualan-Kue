...
<head>
    ...
    <title>Login Aplikasi Stok kue kering</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center mt-5 mb-3">
                ...
                <h3 class="text-white mt-2">Aplikasi Persediaan Kue Kering</h3>
            ...
            <div class="col-md-4 col-sm-12 offset-md-4">
                ...
                <p class="text-white text-center">Toko Aneka Kue || &copy;<script>
                        document.write(new Date().getFullYear());
                    </script> || Shalsa Fadillah R
                </p>
            </div>
        </div>
    </div>
