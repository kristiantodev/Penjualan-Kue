...
<div class="col-md-8">
	...
	<div class="form-group row">
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control form-control-sm <?= (form_error('kemasan')) ? 'is-invalid' : ''; ?>" id="kemasan" name="kemasan" placeholder="Kemasan yang dipakai" value="<?= (set_value('kemasan')); ?>">
            <div class="invalid-feedback">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9 col-md-6">
            <input type="text" class="form-control form-control-sm <?= (form_error('stok')) ? 'is-invalid' : ''; ?>" id="stok" required autofocus name="stok" placeholder="Stok yang tersedia" value="<?= set_value('stok'); ?>">
            <div class="invalid-feedback">
