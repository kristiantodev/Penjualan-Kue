...
<div class="col-md-8">
	...
	<div class="form-group row">
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control form-control-sm <?= (form_error('kemasan')) ? 'is-invalid' : ''; ?>" id="kemasan" name="kemasan" placeholder="Kemasan yang dipakai" value="<?= (set_value('kemasan')) ? set_value('kemasan') : $barang->kemasan; ?>">
            <div class="invalid-feedback">
                <?= form_error('kemasan', '<p class="error-message">', '</p>'); ?>
            </div>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control form-control-sm uang <?= (form_error('stok')) ? 'is-invalid' : ''; ?>" id="stok" name="stok" placeholder="Stok yang tersedia" value="<?= (set_value('stok')) ? set_value('stok') : number_format($barang->stok, 0, ',', '.'); ?>">
            <div class="invalid-feedback">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
            <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input <?= (form_error('status')) ? 'is-invalid' : ''; ?>" id="Tersedia" name="status" value="Y" <?= (ucwords($status) == 'Y') ? 'checked' : ''; ?>>
                <label class="custom-control-label" for="Tersedia">Tersedia</label>
            </div>
		
            <div class="custom-control custom-radio mb-3">
                <input type="radio" class="custom-control-input <?= (form_error('status')) ? 'is-invalid' : ''; ?>" id="Habis" name="status" value="N" <?= (ucwords($status) == 'N') ? 'checked' : ''; ?>>
