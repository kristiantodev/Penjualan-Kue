...
<div class="col-md-12">
    ...
    <div class="form-group row">
        <label for="jumlahx" class="col-sm-2 col-form-label">Jumlah Retur</label>
        <div class="col-sm-2">
            <input type="number" class="form-control form-control-sm" id="jumlahx" placeholder="Jumlah Retur">
        </div>
    </div>
    <div class="form-group row">
