...
<nav id="sidebar">
    <div class="p-4 pt-5">
        <a href="<?= site_url(); ?>" class="img logo rounded-circle mb-3" style="background-image: url(<?= base_url('assets/img/'.$this->session->userdata('foto')); ?>);"></a>
        <ul class="list-unstyled components mb-5">
            ...
            ?>
                ...
                <a href="<?= site_url('data_pembelian'); ?>"><i class="fa fa-reply"></i> Data Pembelian</a>

                <li <?= (in_array(strtolower($this->uri->segment(1)), ['data_retur', 'tambah_retur', 'edit_retur'])) ? 'class="active"' : ''; ?>>
                <a href="<?= site_url('data_retur'); ?>"><i class="fa fa-reply"></i> Data Retur</a>
            </li>
            ...
            <li <?= (in_array(strtolower($this->uri->segment(1)), ['stok_exp_bulanan', 'stok_exp_tahunan'])) ? 'class="active"' : ''; ?>>
                <a href="#pageStokExpired" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <i class="fa fa-file-text-o"></i> Laporan Stok Expired
                </a>

                <ul class="collapse list-unstyled" id="pageStokExpired">
                    <li <?= (strtolower($this->uri->segment(1)) == 'stok_exp_bulanan') ? 'class="active"' : ''; ?>>
                        <a href="<?= site_url('stok_exp_bulanan'); ?>">
                            <i class="fa fa-angle-double-right"></i> Bulanan
                        </a>
                    </li>
                    <li <?= (strtolower($this->uri->segment(1)) == 'stok_exp_tahunan') ? 'class="active"' : ''; ?>>
                        <a href="<?= site_url('stok_exp_tahunan'); ?>">
                            <i class="fa fa-angle-double-right"></i> Tahunan
                        </a>
                    </li>
                </ul>
