...
<body>
 ...
 title: 'Apakah anda yakin akan keluar ?', type: 'warning' , showCancelButton: true, confirmButtonColor: '#DD6B55' , confirmButtonText: 'Ya, Sign Out!', closeOnConfirm: false }, function(){ window.location.href = '<?= site_url('sign_out'); ?>'; });">Sign Out</a>
    ...
    <!-- Custom Javascript -->
    <?php
    $arr_uri = array('stok_barang', 'barang', 'pegawai', 'supplier', 'data_pembelian', 'data_penjualan', 'data_retur');
                ...
                $.ajax({
                    ...
                    success: function(obj) {
                        ...
                        if (a.message == 'success') {
                            swal({
                                title: "Success!",
                                text: "Data barang retur berhasil dihapus",
                                type: "success",
                                showCancelButton: false,
                                showConfirmButton: false,
                                timer: 2000
                            ...
                            swal({
                                title: "Error!",
                                text: "Data barang retur gagal dihapus",
                                type: "error",
                                showCancelButton: false,
                                showConfirmButton: false,
                                timer: 2000
