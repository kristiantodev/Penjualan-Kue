...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-file-text"></i> Laporan Stok Expired Bulanan</h4>
    </div>
</div>
<hr class="mt-0" />
<?php
...
<div class="row">
    ...
    <div class="col-md-2 col-sm-12">
        <a href="<?= site_url('stok_exp_bulanan/' . $bulan . '-' . $tahun); ?>" class="btn btn-success btn-block btn-sm" target="_blank">
    ...
    <tbody>
        ...
        if ($data->num_rows() > 0) {
            foreach ($data->result() as $dt) {
                ...
                echo '<td class="text-center">' . $dt->tgl_exp . '</td>';
