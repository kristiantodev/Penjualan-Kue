...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-users"></i> Detail User</h4>
    </div>
</div>
<hr class="mt-0" />
    ...
    <div class="row no-gutters">
        ...
        <div class="col-md-8 offset-md-1">
            <div class="card-body pt-1">
                ...
                <p class="card-text mb-0"><b>Status User :</b></p>
                <p class="card-text text-muted"><?= ($data->active == 'Y') ? 'User Aktif' : 'User Tidak Aktif'; ?></p>
