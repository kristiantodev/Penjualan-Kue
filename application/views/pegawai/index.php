...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-users"></i> Data User</h4>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="password-baru">Password Baru User</label>
                    <input type="password" class="form-control form-control-sm" id="password-baru" name="pwUser" placeholder="Password Baru User">
                </div>
                <div class="form-group">
