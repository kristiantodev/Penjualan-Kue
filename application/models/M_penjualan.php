...
class M_penjualan extends CI_Model
{
    ...
    {
        $select = 'p.id_penjualan AS id_penjualan, tgl_penjualan, qty, dp.harga AS harga, kode_barang, nama_barang, brand, kemasan, fullname, u.id_user AS id_user, nama_pembeli';
