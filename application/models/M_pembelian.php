...
class M_pembelian extends CI_Model
{
    ...
    {
        $select = 'p.id_pembelian AS id_pembelian, tgl_pembelian, qty, dp.harga AS harga, kode_barang, nama_barang, brand, kemasan, fullname, u.id_user AS id_user, nama_supplier, p.id_supplier AS id_supplier';
